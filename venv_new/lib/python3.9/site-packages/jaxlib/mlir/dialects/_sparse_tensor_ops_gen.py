...
def assemble(result, values, levels, *, loc=None, ip=None) -> _ods_ir.Value:
...
def disassemble(ret_values, ret_levels, val_len, lvl_lens, tensor, out_values, out_levels, *, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
...
def insert(value, tensor, lvl_coords, *, loc=None, ip=None) -> _ods_ir.Value:
...
def coordinates_buffer(result, tensor, *, loc=None, ip=None) -> _ods_ir.Value:
...
def coordinates(result, tensor, level, *, loc=None, ip=None) -> _ods_ir.Value:
...
def positions(result, tensor, level, *, loc=None, ip=None) -> _ods_ir.Value:
...
def values(result, tensor, *, loc=None, ip=None) -> _ods_ir.Value:
